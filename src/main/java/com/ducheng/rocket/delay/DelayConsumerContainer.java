...
@Slf4j
public class DelayConsumerContainer {

    private final DelayRocketMQ delayBasedRocketMQ;

    private final Environment environment;

    public DelayConsumerContainer(DelayRocketMQ delayBasedRocketMQ, Object bean, Method method, Environment environment) {
    ...
    protected DefaultMQPushConsumer createConsumer() throws Exception {
        ...
        String delay = resolve(this.delayBasedRocketMQ.nameServer());
        ...
        // 增加监听器
        consumer.setMessageListener(new DefaultMessageListenerOrderly(Long.valueOf(delay)));
    ...
    private class DefaultMessageListenerOrderly implements MessageListenerOrderly {
        ...
        public DefaultMessageListenerOrderly(Long delayTime) {
            this.delayTime = delayTime;
        }
